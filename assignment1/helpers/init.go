...
func Init() []student {
	data_student := []student{
		{},
		{nama: "Winifred Alvarado", alamat: "P.O. Box 826, 9049 Ridiculus Av.", pekerjaan: "Cashier", alasan: "Suspendisse dui. Fusce diam nunc, ullamcorper eu, euismod ac, fermentum"},
